...
- creating, renaming, deleting, and switching profiles
- adding and editing recipes
- alternate recipes for the same output
- desired route behavior
- base material behavior
- reusable inputs
- fluid units
- large calculations
- machine timing with simultaneous crafts
- moving the whole project folder and launching again

If something looks wrong, note:

- profile name
- target item and amount
- relevant recipe names
- machine settings
